...
//go:embed "schema/health.graphqls" "schema/root.graphqls"
...
func (ec *executionContext) _Query_health(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.Health) graphql.Marshaler {
			return ec.marshalNHealth2ᚖgithubᚗcomᚋsoumajitghᚋmobicodeᚋinternalᚋgraphqlᚋmodelᚐHealth(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) marshalNHealth2ᚖgithubᚗcomᚋsoumajitghᚋmobicodeᚋinternalᚋgraphqlᚋmodelᚐHealth(ctx context.Context, sel ast.SelectionSet, v *model.Health) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
